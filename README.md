...
| `CHATFOLD_APP_URL` | Exact canonical HTTPS origin, such as `https://chatfold.vercel.app` |
...
3. Checkout opens in a separate tab, preserving the original tab’s private chat memory. Card details are entered only on Paystack.
